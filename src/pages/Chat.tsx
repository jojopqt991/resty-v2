...
const Chat = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: "Hi there! I'm Resty, your AI restaurant concierge for London. Tell me what kind of restaurant you're looking for today and I'll help you find the perfect dining spot!",
      role: 'assistant'
    }
  ]);
